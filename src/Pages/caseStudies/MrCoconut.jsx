...
/**
 * MrCoconut Case Study Component
 * Displays a detailed case study for the Mr. Coconut Support Bot project
...
const MrCoconut = () => {
   ...
   * Each step contains a title and description
   * Note: This appears to be placeholder content that should be updated with actual Mr. Coconut process details
   */
  const process = [
    { title: "Discover", description: "Excollo is future-ready, offering unparalleled expertise to enterprises seeking to transform their digital stack. By leveraging cutting-edge AI, automation, and innovative consultancy, we identify opportunities, close gaps, and implement strategies that empower businesses to achieve scalable success." },
    { title: "Define", description: "Excollo is future-ready, offering unparalleled expertise to enterprises seeking to transform their digital stack. By leveraging cutting-edge AI, automation, and innovative consultancy, we identify opportunities, close gaps, and implement strategies that empower businesses to achieve scalable success." },
    { title: "Design", description: "Excollo is future-ready, offering unparalleled expertise to enterprises seeking to transform their digital stack. By leveraging cutting-edge AI, automation, and innovative consultancy, we identify opportunities, close gaps, and implement strategies that empower businesses to achieve scalable success." },
    { title: "Develop", description: "Excollo is future-ready, offering unparalleled expertise to enterprises seeking to transform their digital stack. By leveraging cutting-edge AI, automation, and innovative consultancy, we identify opportunities, close gaps, and implement strategies that empower businesses to achieve scalable success." },
    { title: "Deliver", description: "Excollo is future-ready, offering unparalleled expertise to enterprises seeking to transform their digital stack. By leveraging cutting-edge AI, automation, and innovative consultancy, we identify opportunities, close gaps, and implement strategies that empower businesses to achieve scalable success." }
  ];
          ...
          <Box sx={{
            ...
            fontWeight: 600,
              ...
              <Typography sx={{ 
                ...
                "We'd get messages at midnight: 'Need 300 coconuts for Jan 20 wedding, logo print, can you confirm price?' By the next morning, details were missing or changed, and the team was scrambling."
              </Typography>
            <Typography sx={{
                ...
                That was Mr. Coconut's reality. Personalized coconuts were turning into beautiful centerpieces at weddings and events, but managing orders felt like wrangling dozens of fragmented WhatsApp threads.
            </Typography>
            <Typography sx={{
                fontSize: { xs: 13, sm: 13 }, 
                color: '#fff', 
                ...
                With rising demand came rising tension: missed details, lost leads, exhausted team members. They needed something that worked when the lights are off, but felt warm when chatting with clients.
            </Typography>
          </Box>
...
// Export the MrCoconut component as default
export default MrCoconut;