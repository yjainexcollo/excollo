...
/**
 * Phyllo Case Study Component
 * Displays a detailed case study for the Phyllo project
...
const Phyllo = () => {
  ...
  const process = [
    {
      title: "Discover",
      description: `We collaborated with Phyllo’s HR and operations team to understand the onboarding process. Key challenges included:
• Manual back-and-forth for document collection and verification
• Inconsistent onboarding experience across roles and departments
• HR staff bogged down by repetitive FAQs from new employees`,
    },
    {
      title: "Define",
      description: `The problem was clear: Phyllo needed a scalable, automated onboarding system that reduced HR overhead while delivering a consistent, high‑quality experience to new hires.`,
    },
    {
      title: "Design",
      description: `We designed the assistant as a structured, conversational guide:`,
      points: [
        `Smart Intake Flow – collects employee details, role, and department.`,
        `Automated Document Verification – upload ID proofs, contracts, tax forms; AI validates and stores securely.`,
        `Interactive Q&A – instant answers to onboarding FAQs (payroll setup, leave policy, etc.).`,
        `Personalized Onboarding Plan – step‑by‑step checklist per role (tools, training, intros).`,
      ],
    },
    {
      title: "Develop",
      description: `The platform included:
• Conversational AI trained on Phyllo’s HR policies and SOPs
• Secure integration with internal tools (Google Workspace, Slack, HRIS)
• Auto‑generated onboarding checklists and reminders
• Exportable reports for HR managers to track completion rates`,
    },
    {
      title: "Deliver (Impact & Results)",
      description: `Results were immediate:
• HR time on routine onboarding cut by 65% (more time for strategic work)
• Employees completed onboarding steps 40% faster
• Consistent, professional onboarding improved new‑hire satisfaction
• FAQs once flooding HR inboxes were resolved instantly via AI chat`,
    },
  ];
          ...
          <Box sx={{
            ...
            fontWeight: 600,
              ...
              <Typography sx={{ 
                ...
                "Employee onboarding is one of the most critical touchpoints in the HR journey. Yet for fast-scaling companies, the process often becomes a bottleneck — repetitive form-filling, policy orientation, and manual handoffs that slow down productivity and overwhelm HR teams."
              </Typography>
            ...
            <Typography sx={{
                ...
                Phyllo needed a solution that could make onboarding faster, smoother, and more engaging.
 The Employee Onboarding AI was built to address this challenge. Acting as a virtual HR assistant, it guides new hires through structured onboarding conversations, automates document collection, and delivers personalized onboarding plans — ensuring every employee starts strong from day one.
            </Typography>
          </Box>
            ...
            <Box sx={{ mt: { xs: 2, md: 2 } }}>
              ...
              <Box sx={{ 
                ...
                <Box sx={{ 
                  ...
                  <Typography sx={{
                    ...
                    fontSize: { xs: 14, sm: 16 },
                    mb: 1
                  }}>Employee Ramp-up Time</Typography>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 0.5, md: 1 } }}>
                    <ArrowUpwardIcon className="metric-icon" sx={{ 
                      color: '#8E54F7', 
                      fontSize: { xs: 16, sm: 18 },
              ...
              <Box sx={{ 
                  ...
                  <Typography sx={{ 
                    ...
                    fontSize: { xs: 14, sm: 16 },
                    mb: 1
                  }}>New Hire Experience</Typography>
...
// Export the Phyllo component as default
